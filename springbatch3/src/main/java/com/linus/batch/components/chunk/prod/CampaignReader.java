...
public class CampaignReader implements ItemReader<Campaign> {
  private final Logger log = LoggerFactory.getLogger(CampaignReader.class);
  ...
  public synchronized Campaign read() throws Exception {
