...
/**
 * TaskExecutorRepeatTemplateBasedOnRepeatTemplate has all features of RepeatTemplate and it supports TaskExecutor.
 *
 * @author linus.yan
 * @since 2025-04-25
 */
public class TaskExecutorRepeatTemplateBasedOnRepeatTemplate extends RepeatTemplate {

  private static final Logger logger = LoggerFactory.getLogger(TaskExecutorRepeatTemplateBasedOnRepeatTemplate.class);
  ...
  private class ExecutingRunnable implements Runnable {
    ...
    public void run() {
      ...
      try {
        ...
        if (TaskExecutorRepeatTemplateBasedOnRepeatTemplate.this.logger.isDebugEnabled()) {
          TaskExecutorRepeatTemplateBasedOnRepeatTemplate.this.logger.debug("Repeat operation about to start at count=" + this.context.getStartedCount());
        }
